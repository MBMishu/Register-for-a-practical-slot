!(function (t, e) {
  ...
  function n() {
    var t;
    return h($().querySelectorAll(".".concat(Y.icon)));
  }
  ...
  function H(e, t) {
    ...
    (e.textContent = ""),
      t &&
        (h(
          (n = new DOMParser().parseFromString(t, "text/html")).querySelector(
            "head"
          ).childNodes
        ).forEach(function (t) {
          e.appendChild(t);
        ...
        : (Dt(),
          o.icon &&
            (-1 !== Object.keys(Z).indexOf(o.icon)
              ? (ot((i = C(".".concat(Y.icon, ".").concat(Z[o.icon])))),
                Ut(i, o),
                Nt(),
                N(i, o, "icon"),
  ...
  (jt.text =
    ...
    (jt.select = function (t, e) {
      ...
      return (
        (t.textContent = ""),
        e.inputPlaceholder &&
          (H((n = document.createElement("option")), e.inputPlaceholder),
          (n.value = ""),
          (n.disabled = !0),
          (n.selected = !0),
          t.appendChild(n)),
    ...
    (jt.checkbox = function (t, e) {
      ...
      return (
        ...
        H(t.querySelector("span"), e.inputPlaceholder),
        t
      );
    }),
          ...
          (function (n, o, i) {
            return new Promise(function (t) {
              ...
              de.swalPromiseResolve.set(n, t),
                ...
                Oe(n, o, e),
                Se(n, Xt, i, e),
                i.toast && (i.input || i.footer || i.showCloseButton)
